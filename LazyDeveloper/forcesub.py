    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Hello ! I think you are Banned to use me. Request unban to [Kunal Singh](https://t.me/TheKunalSiingh).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            ...
            text="**🔺 Join Update Channel 🔺**\n\n"
                 "⚔️ Only Subscribers of my channel can use me ⚔️",
